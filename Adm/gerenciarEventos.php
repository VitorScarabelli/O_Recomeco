...
<head>
    ...
    <style>
        ...
        .badge-positivo { background-color: #28a745; color: white; }
        .badge-negativo { background-color: #dc3545; color: white; }
            ...
            <div class="events-table">
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        $query = "SELECT * FROM tbevento $whereClause ORDER BY idEvento DESC";
