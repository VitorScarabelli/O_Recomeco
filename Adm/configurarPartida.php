    ...
    <div class="admin-container">
        ...
        <div class="config-section">
            ...
            <div class="alert alert-info">
                <strong>💡 DICA:</strong> SELECIONE ENTRE 2 E 4 PERSONAGENS PARA A PARTIDA. CADA PERSONAGEM TEM EVENTOS ESPECÍFICOS QUE SERÃO INCLUÍDOS AUTOMATICAMENTE.
            </div>
        ...
        <form method="POST" action="salvarConfiguracao.php">
            <div class="form-section">
                <h3 class="subsection-title">📝 TÍTULO DA CONFIGURAÇÃO</h3>
                <div class="form-group">
            ...
            card.addEventListener('click', function() {
                ...
                if (this.classList.contains('selecionado')) {
                    ...
                    if (personagensSelecionados.length < 4) {
                        ...
                        personagensSelecionados.push({id, nome, emoji});
                    } else {
